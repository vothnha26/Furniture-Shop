...
const OrderDetailManagement = () => {
  ...
  useEffect(() => {
    const mockOrders = [
      { id: 1, maDonHang: 'DH001', tenKhachHang: 'Nguyễn Văn A', ngayDat: '2024-10-01', tongTien: 15000000 },
      { id: 2, maDonHang: 'DH002', tenKhachHang: 'Trần Thị B', ngayDat: '2024-10-02', tongTien: 8500000 },
      { id: 3, maDonHang: 'DH003', tenKhachHang: 'Lê Văn C', ngayDat: '2024-10-03', tongTien: 12000000 }
    ];

    const mockVariants = [
      { id: 1, maBienThe: 'BT001', tenSanPham: 'Ghế Sofa Nordic', thuocTinh: 'Màu đỏ - Chất liệu vải', gia: 5000000 },
      { id: 2, maBienThe: 'BT002', tenSanPham: 'Bàn Ăn Gỗ Sồi', thuocTinh: 'Kích thước 1.6m - Màu nâu', gia: 8000000 },
      { id: 3, maBienThe: 'BT003', tenSanPham: 'Tủ Quần Áo', thuocTinh: 'Màu trắng - 4 cánh', gia: 12000000 },
      { id: 4, maBienThe: 'BT004', tenSanPham: 'Ghế Làm Việc', thuocTinh: 'Màu đen - Có bánh xe', gia: 3500000 }
    ];
    ...
    const mockOrderDetails = [
      {
        ...
        soLuong: 2,
        donGiaGoc: 5000000,
        donGiaThucTe: 4500000,
        donHang: mockOrders[0],
        bienThe: mockVariants[0]
      },
      {
        id: 2,
        maDonHang: 1,
        ...
        soLuong: 1,
        donGiaGoc: 8000000,
        donGiaThucTe: 8000000,
        donHang: mockOrders[0],
        bienThe: mockVariants[1]
      },
      {
        id: 3,
        maDonHang: 2,
        ...
        soLuong: 1,
        donGiaGoc: 12000000,
        donGiaThucTe: 11000000,
        donHang: mockOrders[1],
        bienThe: mockVariants[2]
      },
      {
        id: 4,
        maDonHang: 3,
        ...
        soLuong: 3,
        donGiaGoc: 3500000,
        donGiaThucTe: 3200000,
        donHang: mockOrders[2],
        bienThe: mockVariants[3]
      }
    ];
    ...
    setFilteredDetails(mockOrderDetails);
  }, []);
