...
import { IoAdd, IoCreate, IoTrash, IoEye, IoSearch, IoFilter, IoDownload, IoTrophy, IoStar, IoTrendingUp, IoGift, IoTime } from 'react-icons/io5';
...
const MembershipTierManagement = () => {
  ...
  const deleteTier = async (id) => {
    try {
      await api.del(`/api/hang-thanh-vien/${id}`);
      ...
      <div className="bg-white rounded-lg shadow p-4 mb-6">
        <div className="flex flex-col lg:flex-row gap-4 items-center justify-between">
          ...
          <div className="flex gap-2">
            <button
              onClick={() => {
                setNewTier(initialNewTier); // Reset on open
          ...
          <div key={tier.maHang} className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
            ...
            <div className="p-4">
              ...
              <div className="flex justify-between mt-4 pt-3 border-t border-gray-200">
                ...
                <button
                  onClick={() => {
                    // Open benefits-only modal for this tier
                    setBenefitsEditingTier({
                      ...tier,
                      // keep numeric fields as strings for inputs if needed
                ...
                <button
                  onClick={() => {
                    // Prepare data for editing, converting numbers to strings for input fields
                    setEditingTier({
                      ...tier,
                      diemToiThieu: String(tier.diemToiThieu ?? ''),
                      tiLeGiam: String(tier.tiLeGiam ?? ''),
