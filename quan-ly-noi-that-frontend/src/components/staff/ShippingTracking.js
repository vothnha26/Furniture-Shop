  ...
  const [orders] = useState([
    {
      ...
      timeline: [
        ...
        { status: 'delivered', time: '2024-01-19 15:45', location: '123 Đường ABC, Quận 1', description: 'Giao hàng thành công' }
      ]
    },
    {
      id: 'ORD002',
      ...
      timeline: [
        { status: 'confirmed', time: '2024-01-18 10:00', location: 'Cửa hàng', description: 'Đơn hàng đã được xác nhận' },
        { status: 'processing', time: '2024-01-18 16:00', location: 'Kho hàng', description: 'Đang chuẩn bị hàng' },
        { status: 'shipped', time: '2024-01-19 09:00', location: 'Trung tâm phân phối', description: 'Đã xuất kho' },
        { status: 'in_transit', time: '2024-01-20 11:00', location: 'Đang vận chuyển', description: 'Đang giao hàng' }
      ]
    }
  ]);
