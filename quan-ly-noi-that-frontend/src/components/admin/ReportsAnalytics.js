...
import { IoBarChart, IoPieChart, IoTrendingUp, IoTrendingDown, IoDownload, IoCalendar, IoRefresh, IoEye } from 'react-icons/io5';
...
const ReportsAnalytics = () => {
  ...
  const salesData = [
    { date: '2024-01-01', revenue: 15000000, orders: 5 },
    { date: '2024-01-02', revenue: 22000000, orders: 8 },
    { date: '2024-01-03', revenue: 18000000, orders: 6 },
    { date: '2024-01-04', revenue: 25000000, orders: 9 },
    { date: '2024-01-05', revenue: 30000000, orders: 12 },
    { date: '2024-01-06', revenue: 28000000, orders: 11 },
    { date: '2024-01-07', revenue: 32000000, orders: 13 }
  ];

  const productSales = [
    { name: 'Ghế gỗ cao cấp', sales: 45, revenue: 112500000 },
    { name: 'Bàn ăn 6 người', sales: 32, revenue: 144000000 },
    { name: 'Tủ quần áo 3 cánh', sales: 28, revenue: 89600000 },
    { name: 'Giường ngủ gỗ', sales: 15, revenue: 90000000 },
    { name: 'Kệ sách', sales: 22, revenue: 66000000 }
  ];

  const customerStats = [
    { level: 'VIP Diamond', count: 5, revenue: 150000000 },
    { level: 'VIP Platinum', count: 12, revenue: 180000000 },
    { level: 'VIP Gold', count: 25, revenue: 200000000 },
    { level: 'VIP Silver', count: 45, revenue: 120000000 },
    { level: 'Thường', count: 120, revenue: 300000000 }
  ];

  const inventoryAlerts = [
    { product: 'Ghế gỗ cao cấp', currentStock: 3, minStock: 5, status: 'low' },
    { product: 'Bàn ăn 6 người', currentStock: 1, minStock: 3, status: 'critical' },
    { product: 'Tủ quần áo 3 cánh', currentStock: 0, minStock: 2, status: 'out' }
  ];
  ...
  const demoReports = {
    sales: {
      ...
      data: [
        { metric: 'Tổng doanh thu', value: '1,850,000,000đ', change: '+12.5%' },
        { metric: 'Số đơn hàng', value: '156', change: '+8.2%' },
        { metric: 'Giá trị đơn hàng TB', value: '11,858,974đ', change: '-2.1%' },
    ...
    inventory: {
      ...
      data: [
        { metric: 'Tổng sản phẩm', value: '45', change: '+3' },
        { metric: 'Tồn kho bình thường', value: '38', change: '+5' },
        { metric: 'Sắp hết hàng', value: '5', change: '-2' },
        { metric: 'Hết hàng', value: '2', change: '+1' }
      ]
    },
    customers: {
      ...
      data: [
        { metric: 'Tổng khách hàng', value: '1,234', change: '+23' },
        { metric: 'Khách hàng mới', value: '89', change: '+15.3%' },
        { metric: 'Khách hàng VIP', value: '45', change: '+8' },
    ...
    products: {
      ...
      data: [
        { metric: 'Sản phẩm bán chạy', value: 'Ghế gỗ cao cấp', change: '45 đơn' },
        { metric: 'Doanh thu cao nhất', value: '144,000,000đ', change: 'Bàn ăn 6 người' },
    ...
    financial: {
      ...
      data: [
        { metric: 'Doanh thu thuần', value: '1,850,000,000đ', change: '+12.5%' },
        { metric: 'Chi phí vận hành', value: '450,000,000đ', change: '+8.2%' },
        { metric: 'Lợi nhuận gộp', value: '1,400,000,000đ', change: '+15.3%' },
  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      <div className="max-w-7xl mx-auto">
        ...
        {selectedReportType !== 'overview' && demoReports[selectedReportType] && (
          <div className="bg-white rounded-lg shadow-sm p-6 mb-8">
            <div className="flex items-center justify-between mb-6">
              <div>
                <h3 className="text-xl font-semibold text-gray-900">{demoReports[selectedReportType].title}</h3>
                <p className="text-gray-600">{demoReports[selectedReportType].description}</p>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {demoReports[selectedReportType].data.map((item, index) => (
